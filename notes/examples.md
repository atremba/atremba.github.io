---
layout: page
title: Примеры Jekyll + Markdown
---

На основе [страницы примеров](https://github.com/poole/poole/blob/master/_posts/2016-01-02-example-content.md).

# Не-markdown разметка
