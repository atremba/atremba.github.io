...
Можно посмотреть [исходный текст этой записи](TODO) как источник примеров.
...
Кроме [полный список фильтров Jekyll и Liquid](https://jekyllrb.com/docs/liquid/filters/), удобно
...
данных](/TODO#liquid-database) с помощью файлов данных (в режиме чтение).
...
- <https://help.shopify.com/en/themes/liquid> - альтернативная, немного устаревшая докуменатация на сайте Shopify, создателя Liquid. Здесь
  ...
  - есть ссылка на [примеры кода](https://shopify.github.io/liquid-code-examples).
