...
- [установить локальную версию Jekyll]({% post_url 2019-04-24-local-jekyll %}) для отладки изменений и записей,
- [познакомиться с git (в плане)](/TODO#git) в контексте работы с сайтом на Github Pages,
- изучить [возможности `markdown` (в плане)](/TODO#markdown) для редактирования текстов,
